from project.Config import AddNewAnimal
from project.Config.Counter import Counter
from project.Config.TechNewCommand import TeachNewCommands
from Output import print_animal
